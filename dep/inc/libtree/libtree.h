...
void bstree_replace(struct bstree_node *old, struct bstree_node *new_node_node, struct bstree *tree);
...
void rbtree_replace(struct rbtree_node *old, struct rbtree_node *new_node, struct rbtree *tree);
...
void avltree_replace(struct avltree_node *old, struct avltree_node *new_node, struct avltree *tree);
...
void splaytree_replace(struct splaytree_node *old, struct splaytree_node *new_node, struct splaytree *tree);
